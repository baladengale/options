...
def build_parser():
    parser = argparse.ArgumentParser(
        description="Call the capital anomaly skill backend.",
    )
    parser.add_argument("stock_symbol", help="Stock symbol, such as US.TSLA or HK.00700")
...
def main():
    ...
    if ret != RET_OK:
        print(f"get_financial_unusual error: {data}", file=sys.stderr)
        return 1
